...
public class LogMech {
    ...
    public static void logMe(){
		...
		System.out.format("%-9s\t", RobotMap.driveLeftMotor1.getEncPosition());
		System.out.format("%-9s\t", DriveMath.calcDist(RobotMap.driveLeftMotor1.getEncPosition(), "IN"));
		System.out.format("%-9s\t", DriveMath.calcTurns(RobotMap.driveLeftMotor1.getEncPosition()));
		System.out.format("%-9s\t", RobotMap.driveRightMotor1.getEncPosition());
		System.out.format("%-9s\t", RobotMap.driveRightMotor1.getEncVelocity());
		System.out.format("%-9s\t", RobotMap.driveLeftMotor1.getEncVelocity());
		System.out.format("%-9s\t", RobotMap.digitalSPIGyro.getAngle());
		System.out.format("%-9s\t", RobotMap.digitalSPIGyro.getRate());
		System.out.format("%-9s\t", RobotMap.driveRightMotor1.getPulseWidthVelocity());
		System.out.format("%-9s\t", RobotMap.driveLeftMotor1.getPulseWidthVelocity());
