...
public class RobotMap {
    ...
    public static void init() {
     ...
     /*   driveRightMotor1 = new TalonSRX(3);
        LiveWindow.addActuator("Drive", "RightMotor1", (TalonSRX) driveRightMotor1);
        
        driveRightMotor2 = new TalonSRX(4);
        LiveWindow.addActuator("Drive", "RightMotor2", (TalonSRX) driveRightMotor2);
        
        driveLeftMotor1 = new Talon(5);
        LiveWindow.addActuator("Drive", "LeftMotor1", (Talon) driveLeftMotor1);
        
        driveLeftMotor2 = new Talon(6);
        ...
        collectorMotorBC = new TalonSRX(0);
        LiveWindow.addActuator("Collector", "MotorBC", (TalonSRX) collectorMotorBC);
        
        shooterShooterMotor = new TalonSRX(1);
        ...
        ellevatorEllevatorMotor = new TalonSRX(2);
        LiveWindow.addActuator("Ellevator", "EllevatorMotor", (TalonSRX) ellevatorEllevatorMotor);
        
        climberClimberMotor1 = new TalonSRX(7);
        LiveWindow.addActuator("Climber", "ClimberMotor1", (TalonSRX) climberClimberMotor1);
        
        climberClimberMotor2 = new TalonSRX(8);
        LiveWindow.addActuator("Climber", "ClimberMotor2", (TalonSRX) climberClimberMotor2);
       */ 
