...
public class OI {
    ...
    public OI() {
        ...
        shooterDoorOpen = new JoystickButton(driveStick, 11);
        shooterDoorOpen.whenPressed(new ShooterDoorOpen());
        shooterDoorClose = new JoystickButton(driveStick, 10);
        shooterDoorClose.whenPressed(new ShooterDoorClose());
        agitate = new JoystickButton(utilityStick, 7);
        agitate.whenPressed(new Agitate());
        stopAgitate = new JoystickButton(utilityStick, 6);
